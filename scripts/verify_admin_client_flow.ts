...
async function request(url: string, method: string, body?: any, token?: string) {
    ...
    return { data }; // Axios style wrapper
}
...
async function verifyFlow() {
    try {
        ...
        const adminLogin = await request(`${API_URL}/auth/login`, 'POST', {
            email: 'admin@prism.com', // Assuming this user exists from seed
        ...
        // Client should see the project in "getClientProjects" or "getProjectById"
        // Let's try getProjectById
